...
<head>
    ...
    @if($deferMobileOptionalScripts)
        <script>
            window.__mobileOptionalStyles = [
                '/css/m/anypicker-all.min.css?{{ date('Ymdhis') }}',
                '/css/m/anypicker.css?{{ date('Ymdhis') }}',
                '/css/m/anypicker-ios.css?{{ date('Ymdhis') }}',
                'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css'
            ];
            window.__mobileOptionalScripts = [
                'https://code.jquery.com/ui/1.12.1/jquery-ui.js?{{ date('Ymdhis') }}',
                'https://cdnjs.cloudflare.com/ajax/libs/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js?{{ date('Ymdhis') }}',
                '/js/m/anypicker.js?{{ date('Ymdhis') }}',
                '/js/m/anypicker-i18n-ko.js?{{ date('Ymdhis') }}',
    ...
    <script @if($deferMobileOptionalScripts) defer @endif src="/js/m/common.js?{{ date('Ymdhis') }}"></script>
