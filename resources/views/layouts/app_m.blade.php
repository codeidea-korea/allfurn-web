...
<head>
    ...
    @endphp
    <link rel="stylesheet" href="/css/m/font.css">
    {{-- <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.css"> --}}
    {{-- <link href="https://cdn.jsdelivr.net/npm/anypicker/dist/anypicker-all.min.css" rel="stylesheet"> --}}
    <link rel="stylesheet" href="/css/m/swiper-bundle.min.css">
    @unless($deferMobileOptionalScripts)
        <link rel="stylesheet" href="/css/m/anypicker-all.min.css">
    @endunless
    <link rel="stylesheet" href="/css/m/common.css?{{ date('Ymd') }}">
    <link rel="stylesheet" href="/css/m/style.css?{{ date('Ymd') }}">
    <link rel="stylesheet" href="/css/m/rubin.css">
    @unless($deferMobileOptionalScripts)
        <link rel="stylesheet" href="/css/m/anypicker.css">
        <link rel="stylesheet" href="/css/m/anypicker-ios.css">
    @endunless
    {{-- <link rel="stylesheet" href="/css/output.css"> --}}

    <script src="/js/jquery-1.12.4.js"></script>
    <script defer src="/js/pci.js"></script>
    @if($deferMobileOptionalScripts)
        <script>
            window.__mobileOptionalStyles = [
                '/css/m/anypicker-all.min.css',
                '/css/m/anypicker.css',
                '/css/m/anypicker-ios.css',
                'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.css'
            ];
            window.__mobileOptionalScripts = [
                'https://code.jquery.com/ui/1.12.1/jquery-ui.js',
                'https://cdnjs.cloudflare.com/ajax/libs/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js',
                '/js/m/anypicker.js',
                '/js/m/anypicker-i18n-ko.js',
                'https://cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js'
            ];
            window.__loadMobileOptionalStyles = function(){
                if(window.__mobileOptionalStylesLoaded){
                    return Promise.resolve();
                }

                window.__mobileOptionalStylesLoaded = true;
                return Promise.all(window.__mobileOptionalStyles.map(function(href){
            ...
            window.__loadMobileOptionalScripts = function(){
                if(window.__mobileOptionalScriptsPromise){
                    return window.__mobileOptionalScriptsPromise;
                }

                window.__mobileOptionalScriptsLoaded = true;
                window.__mobileOptionalScriptsPromise = window.__loadMobileOptionalStyles().then(function(){
                    return window.__mobileOptionalScripts.reduce(function(chain, src){
            ...
            document.addEventListener('focusin', function(event){
                if(event.target.closest('.datepicker, .anypicker, [data-load-mobile-optional-scripts]')){
                    window.__loadMobileOptionalScripts();
                }
            });
            document.addEventListener('click', function(event){
                if(event.target.closest('[data-load-mobile-optional-scripts]')){
                    window.__loadMobileOptionalScripts();
                }
            });
        </script>
    ...
    @unless($deferMobileOptionalScripts)
        <script src="/js/m/anypicker.js"></script>
        <script src="/js/m/anypicker-i18n-ko.js"></script>
    @endunless

    <script @if($deferMobileOptionalScripts) defer @endif src="/js/m/common.js?{{ date('YmdH') }}"></script>
