...
<head>
    ...
    <script defer src="https://code.jquery.com/ui/1.12.1/jquery-ui.js?{{ date('Ymdhis') }}"></script>
    <script defer src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui-touch-punch/0.2.3/jquery.ui.touch-punch.min.js?{{ date('Ymdhis') }}"></script>
    <script defer src="https://cdn.tailwindcss.com"></script>
    {{-- <script defer src="https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js?{{ date('Ymdhis') }}"></script> --}}
    <script defer src="/js/m/swiper-bundle.min.js?{{ date('Ymdhis') }}"></script>

    <!-- <script defer src="https://code.jquery.com/jquery-3.6.0.min.js"></script> -->
    <script defer src="/js/m/anypicker.js?{{ date('Ymdhis') }}"></script>
    <script defer src="/js/m/anypicker-i18n-ko.js?{{ date('Ymdhis') }}"></script>

    <script defer src="/js/m/common.js?{{ date('Ymdhis') }}"></script>
