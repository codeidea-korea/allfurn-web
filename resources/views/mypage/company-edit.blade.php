...
@section('content')
            ...
            <div class="com_setting">
                ...
                <form method="PUT" name="companyForm" id="companyForm" action="/mypage/company" enctype="multipart/form-data">
                    <div class="border-t-2 border-gray-500">
                        <div class="stting_wrap w-[962px] mx-auto mt-8">
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0">홈페이지명</dt>
                                    <dd class="font-medium">{{ $info -> company_name }}</dd>
                                </dl>
                            </div>
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0">대표자</dt>
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="essential w-[190px] shrink-0 mt-2">홈페이지 연락처</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="border-t py-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">홈페이지 소재지</dt>
                                    <dd class="font-medium w-full">
                                                                ...
                                                                <div class="my_filterbox h-[48px]">
                                                                    ...
                                                                    <div class="filter_dropdown_wrap w-[582px]">
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                <a href="javascript: void(0);" class="flex items-center" data-domestic-type="{{ $loop -> index + 1 }}">
                                                                                    {{ $domestic }}
                                                                                </a>
                                                                            </li>
                                                                            @endforeach
                                    ...
                                    <dd class="font-medium w-full">
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if ($info->top_banner_image)
                                                <div class="border border-dashed w-full h-[140px] rounded-md relative flex items-center justify-center desc__gallery" data-image-src="{{ $info->top_banner_image}}">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">공지 내용</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">근무일</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">이메일</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">담당자</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">담당자 연락처</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">팩스</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">발주 방법</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">웹사이트</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">기타</dt>
                                    <dd class="font-medium w-full">
                            ...
                            <div class="mb-4">
                                <dl class="flex">
                                    <dt class="w-[190px] shrink-0 mt-2">소개</dt>
                                    <dd class="font-medium w-full">
    ...
    <script>
        ...
        const previewImage2 = evt => {
            const reader = new FileReader();
            reader.onload = function(e) {
                document.getElementById('previewSelectImage2').style.backgroundImage = "url('" + e.target.result + "')";
                document.getElementById('previewSelectImage2').style.backgroundSize = '100%';
                document.getElementById('deletePreviewBannerImage').classList.remove('hidden');
                document.querySelectorAll('.default-add-image2').forEach(elem => elem.classList.add('hidden'));
            };
            if (evt.currentTarget.files.length) {
                reader.readAsDataURL(evt.currentTarget.files[0]);
            } else {
                document.getElementById('previewSelectImage2').removeAttribute('style');
                document.getElementById('deletePreviewBannerImage').classList.add('hidden');
                document.querySelectorAll('.default-add-image2').forEach(elem => elem.classList.remove('hidden'));
            }
        }
        ...
        const deletePreviewBannerImage = () => {
            const element = document.querySelector('[name=top_banner]');
            element.value = '';
        ...
        const submitCompany = () => {
            ...
            formData.append('top_banner', document.querySelector('input[type="file"]').files[1]);
        ...
        document.querySelector('[name="top_banner"]').addEventListener('change', e => previewImage2(e));

        document.getElementById('deletePreviewLogoImage').addEventListener('click', deletePreviewLogoImage);
        document.getElementById('deletePreviewBannerImage').addEventListener('click', deletePreviewBannerImage);
        ...
        if (document.getElementById('deleteTopBannerImage')) {
            document.getElementById('deleteTopBannerImage').addEventListener('click', e => {
                deleteLogoImage(e.currentTarget);
            });
        }
