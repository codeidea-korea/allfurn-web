                        ...
                        <ul class="swiper-wrapper">
                            @foreach ($theme['groups'] as $key => $goods) 
                                ...
                                <li class="swiper-slide prod_item">
                                    <div class="img_box">
                                        <a href="/product/detail/{{ $goods['mdp_gidx'] }}"><img src="data:image/gif;base64,R0lGODlhAQABAAAAACw=" data-src="{{ $goods['mdp_gimg'] }}" loading="lazy" decoding="async" fetchpriority="low" alt=""></a>
