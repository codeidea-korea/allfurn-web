                ...
                <div class="head__util">
                    <div class="util__link">
                        ...
                        @else
                            ...
                            <a href="{{ route('signup.new') }}">회원가입</a>
                        @endif
                    </div>
                </div>
        ...
        <div class="inner__full">
            <div class="intro intro__top">
                <div class="inner">
                    ...
                    <div class="image"><img loading="lazy" decoding="async" alt="인트로 이미지" src="/ver.1/images/home/allfurn_intro.png" /></div>
                </div>
            </div>
            <div class="intro intro01">
                <div class="inner">
                    ...
                    <div class="image"><img loading="lazy" decoding="async" alt="인트로 이미지" src="/ver.1/images/home/allfurn_intro001.png" /></div>
                </div>
            </div>
            <div class="intro intro02">
                <div class="inner">
                    ...
                    <div class="image"><img loading="lazy" decoding="async" alt="인트로 이미지" src="/ver.1/images/home/allfurn_intro002.png" /></div>
                </div>
            </div>
            <div class="intro intro03">
                <div class="inner">
                    ...
                    <div class="image"><img loading="lazy" decoding="async" alt="인트로 이미지" src="/ver.1/images/home/allfurn_intro003.png" /></div>
                </div>
            </div>
            <div class="intro intro04">
                <div class="inner">
                    ...
                    <div class="image"><img loading="lazy" decoding="async" alt="인트로 이미지" src="/ver.1/images/home/allfurn_intro004.png" /></div>
                </div>
            </div>
        </div>
    </div>
