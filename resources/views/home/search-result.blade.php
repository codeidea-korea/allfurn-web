    ...
    <section class="sub">
        <div class="inner">
            ...
            <div class="sub_category">
                <ul>
                    <li class="active"><a href="javascript:void(0);">상품</a></li>
                    ...
                    <div class="full_search filter_dropdown_wrap w-[360px]" style="display: none;">
                        <div class="category_list" style="display: block;">
                            <ul>
                                <li>
                                    <a href="javascript:;">
                                        <i><img class="category__ico" src="{{ preImgUrl() }}product/65eb364492edcb02df94fb038753c10868ecf25416b2963ce8bf92c626b7eed2.png"></i>
                                        <span>침대/매트리스</span>
                                    </a>
                                    <ul class="depth2">
            ...
            <div class="sub_filter mt-5">
                <div class="total"><span>‘{{$_GET['kw']}}'</span> 검색 결과 총 1개의 상품</div>
