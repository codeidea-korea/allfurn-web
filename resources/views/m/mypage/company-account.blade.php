...
@section('content')
    ...
    <div id="content">
        <div class="com_setting">
            ...
            <div class="p-4">
                <p class="text-base font-bold">대표</p>
                <div class="divide-y">
                    <div class="flex items-center py-4">
                        <p class="w-[120px] text-stone-400">회원구분</p>
                        <p>{{ $user -> type === 'W' ? '도매' : '소매' }}</p>
                    </div>
                    <div class="flex items-center py-4">
                        <p class="w-[120px] text-stone-400">이메일(아이디)</p>
                        <p>{{ $user -> account }}</p>
                    </div>
                    <div class="flex items-center py-4">
                        <p class="w-[120px] text-stone-400">사업자등록번호</p>
                        <p>{{ $company -> business_license_number }}</p>
                        <button class="border rounded-sm h-[30px] px-3 ml-auto font-medium" onclick="modalOpen('#view_business_modal')">보기</button>
                    </div>
                    <div class="flex items-center py-4">
                        <p class="w-[120px] text-stone-400">업체명</p>
                        <p>{{ $company -> company_name }}</p>
                    </div>
                    <div class="flex items-center py-4">
                        <p class="w-[120px] text-stone-400">대표자명</p>
                        <p>{{ $company -> owner_name }}</p>
                    </div>
                    <div class="flex items-center py-4">
                        <p class="w-[120px] text-stone-400">휴대폰 번호</p>
                        <p>{{ $company -> phone_number }}</p>
                        <button class="flex items-center gap-1 text-primary ml-auto shrink-0" onclick="modalOpen('#edit_phone_number')">
                            <span>수정</span>
                    ...
                    <div class="flex items-start py-4">
                        <p class="w-[120px] text-stone-400 shrink-0">사업자 주소 </p>
                        <p>{{ $company -> business_address }} {{ $company -> business_address_detail }}</p>
                        <button class="flex items-center gap-1 text-primary ml-auto shrink-0" onclick="modalOpen('#edit_business_number')">
                            <span>수정</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right w-4 h-4"><path d="m9 18 6-6-6-6"/></svg>
                        </button>
                    </div>
            ...
            {{-- <div class="p-4 bg-stone-100">
                ...
                @else
                <div class="mt-2 text-stone-400 bg-white rounded-sm shadow-sm p-4 flex items-center justify-center" onclick="getCompanyMember_create()">
                    신규 직원을 등록해주세요.
                </div>
                @endif
            ...
            <div class="modal_body filter_body">
                ...
                <form name="memberForm" id="memberForm">
                    ...
                    <div class="com_setting py-3">
                        ...
                        <div class="mt-4 confirm_password hidden">
    ...
    <script>
        ...
        const getCompanyMember_create = () => {
            document.querySelector('.confirm_password').classList.remove('hidden');
        ...
        const getCompanyMember_update = (idx, name, phone_number, account) => {
            document.querySelector('.confirm_password').classList.add('hidden');
