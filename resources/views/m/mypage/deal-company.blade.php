...
@section('content')
    ...
    <div id="content">
        <div class="sticky top-0 z-10">
            <div class="flex items-center bg-white justify-center items-center border-b">
                <a href="/mypage/deal" class="my_tab w-full text-center py-2.5">상품별</a>
                <a href="/mypage/deal-company" class="my_tab active w-full text-center py-2.5">업체별</a>
            </div>

            <div class="p-4 bg-white flex flex-wrap items-center gap-2 shadow-sm">
                        ...
                        <a href="/mypage/order/detail?orderGroupCode={{ $order -> order_group_code }}&type=S">
                            <div class="p-4 rounded-t-sm border-b">
                                <div class="flex items-center">
                                    <span class="bg-primaryop p-1 text-xs text-primary rounded-sm font-medium">{{ config('constants.ORDER.STATUS.S')[$order -> order_state] }}</span>
                            ...
                            <div class="flex items-center justify-between p-4">
                                <div>
                                    <p class="font-bold text-base">{{ $order -> company_name }}</p>
                                    <p class="mt-1 text-stone-500">{{ $order -> product_name }}</p>
                                </div>
                            </div>
                        </a>
                    </li>
    ...
    <script>
        ...
        const searchOrder = params => {
            ...
            location.href = '/mypage/deal-company?' + new URLSearchParams(bodies);
        }
        ...
        const moveToOrderPage = page => {
            ...
            location.replace('/mypage/deal-company?' + new URLSearchParams(bodies));
        }
