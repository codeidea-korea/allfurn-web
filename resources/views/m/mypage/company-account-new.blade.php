    ...
    <div id="content">
        <div class="com_setting">
            ...
            <div class="tab_content">
                <!-- 회원정보 -->
                <div>
                    <div class="flex flex-col items-center justify-center gap-3 p-4 border-b border-stone-600">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">회원명</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal" placeholder="" id="user_name" value="{{ $user -> name }}">
                            </div>
                        </div>
                        <!--
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">회원구분</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal" placeholder="" >
                            </div>
                        </div>
                        -->
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">이메일(아이디)</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal" placeholder="" id="user_email" value="{{ $user -> account }}" disabled>
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">휴대폰번호</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal" placeholder="" id="user_phone" value="{{ $user -> phone_number }}">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">명함</div>
                            <div class="font-medium w-full flex items-center gap-2">
                ...
                <!-- 회사정보 -->
                <div class="active">
                    <div class="flex flex-col items-center justify-center gap-3 p-4 border-b border-stone-600 _company_section">
                        ...
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">사업자번호</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal  business_code" placeholder="사업자등록번호" 
                                    value="{{ $company -> business_license_number }}">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">업체명</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal  owner_name" placeholder="업체명"
                                    value="{{ $company -> company_name }}">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">대표자명</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal  company_name" placeholder="대표자명"
                                    value="{{ $company -> owner_name }}">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">사업자 주소</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal  business_address" placeholder="회사주소"
                                    value="{{ $company -> business_address }}">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">사업자 상세주소</div>
                            <div class="font-medium w-full flex items-center gap-2">
                                <input type="text" class="setting_input input-form w-full font-normal  business_address_detail" placeholder="주소"
                                    value="{{ $company -> business_address_detail }}">
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 w-full">
                            <div class="essential shrink-0 mt-2">사업자등록증</div>
                            <div class="font-medium w-full flex items-center gap-2">
