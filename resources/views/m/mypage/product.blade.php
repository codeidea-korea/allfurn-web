...
@section('content')
    ...
    <div id="content">
        <div class="flex gap-10 mb-10">
            <div class="w-full">
                <div class="z-10 sticky top-0 flex items-center my_like_tab_wrap gap-4 border-b border-slate-200 bg-white duration-[400ms]">
                    <button class="my_like_tab w-1/2 py-3 text-gray-400 {{ request() -> get('type') !== 'temp' ? 'active' : '' }}" data-target="section01" onclick="location.href='/mypage/product?order=DESC'">
                        <span>등록({{ $register_count }})</span>
                    </button>
                    <button class="my_like_tab w-1/2 py-3 text-gray-400 {{ request() -> get('type') === 'temp' ? 'active' : '' }}" data-target="section02" onclick="location.href='/mypage/product?type=temp&order=DESC'">
                ...
                <div class="inner mt-4">
                    <div class="sub_filter w-full">
                        <div class="filter_box w-full justify-between">
                            <div class="flex gap-2 w-full overflow-x-auto overflow-y-hidden whitespace-nowrap">
                                ...
                                <button href="javascript: ;" class="refresh_btn" onclick="settingInput()"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search text-gray-400"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg></button>
                            </div>
                            <!--
                            <div class="flex gap-2 w-full overflow-x-auto overflow-y-hidden whitespace-nowrap">
                                <button onclick="modalOpen('#product_status_modal')" class="section02_del on">상품 상태</button>
                                <button class="on" onclick="modalOpen('#filter_category-modal')">카테고리 <b class="txt-primary">3</b></button>
                                <button class="order_filter">최근 등록순</button>
                                <button class="refresh_btn" href="javascript:;" onclick="settingInput()"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-search text-gray-400"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg></button>
                            </div>
                            -->
                            <div class="setting_input hidden w-full h-[48px] flex items-center justify-center gap-3">
                    ...
                    <div class="sub_filter_result">
                        <div class="filter_on_box">
                            <div class="category">
                                ...
                                <span>
                                    {{ $category }} 
                                    <button data-category="{{ $category }}" onclick="removeCheckedCategoryBtn(this)"><svg><use xlink:href="/img/icon-defs.svg#x"></use></svg></button>
                                </span>
                                @endforeach
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li class="border-b pb-3 mb-6">
                                    ...
                                    <div class="flex items-center justify-between py-2.5 bg-stone-100 rounded-md mt-1">
                                    ...
                                    <div class="flex items-center justify-between gap-2 rounded-md mt-2">
                                        <a href="/product/modify/{{ $represent -> idx }}" class="flex items-center justify-center w-full h-10 border border-stone-300 rounded text-stone-600">수정</a>
                                        <button class="w-full h-10 border border-stone-300 rounded text-stone-600" onClick="deleteProductModal({{ $represent -> idx }})">삭제</button>
                                    </div>
                                </li>
                                @endforeach
                            </ul>
                    ...
                    <div class="mt-9">
                        ...
                        @else
                            <ul>
                                ...
                                <li class="border-b pb-3 mb-6">
                                    <div class="flex items-center justify-between pb-2 mb-2 border-b">
                                        <span class="text-sm px-2 py-0.5 rounded-sm bg-primary text-white font-medium">{{ config('constants.PRODUCT_STATUS')[$row -> state] }}</span>
                ...
                <!--
                <div class="my_like_tab_section pt-5" id="section02">
                    <div class="flex flex-col p-3 border border-stone-300 rounded-md mb-2">
                        <div class="flex items-center justify-between text-sm text-stone-400 border-b pb-2">
                            <span>최근 수정 2024.03.04</span>
                            <div class="flex items-center gap-3">
                                <a href="./prod_registration.php">수정</a>
                                <span>|</span>
                                <button>삭제</button>
                            </div>
                        </div>
                        <div class="pt-4 pb-2">
                            ...
                            <div class="text-lg">이태리매트리스_포르마 (LK)</div>
                        </div>
                    </div>
                    <div class="flex flex-col p-3 border border-stone-300 rounded-md mb-2">
                        <div class="flex items-center justify-between text-sm text-stone-400 border-b pb-2">
    ...
    <script>
        ...
        const settingInput = () => {
            $('.setting_input').toggleClass('hidden');
