                ...
                @else
                    ...
                    <li class="bg-white shadow-sm">
                        ...
                        <div class="px-4 pb-4 rounded-b-sm flex justify-between gap-2">
                            ...
                            <a href="/mypage/checkRuquestEstimate/{{ $list -> estimate_idx }}" class="flex items-center justify-center h-[42px] text-primary border border-primary font-medium w-full rounded-sm request_estimate_detail">견적 요청서 확인</a>
                            @elseif ($list -> estimate_state == 'R' || $list -> estimate_state == 'H')
                            <a href="/mypage/sendResponseOrder/{{ $list -> estimate_idx }}" class="flex items-center justify-center h-[42px] text-primary border border-primary font-medium w-full rounded-sm response_estimate_detail">견적서 확인</a>
