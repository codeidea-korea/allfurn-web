    ...
    <section class="join_common" style="padding-top:0; ">
        ...
        <div class="join_inner">
            ...
            <div class="form_tab_content">
                <div class="form_box">
                    <a href="javascript:;" id="naver" class="btn !h-14 mb-2 text-white" style="background-color:#6dc66e;">
                    ...
                    <a href="javascript:;" id="kakao" class="btn !h-14 mb-2 text-white" style="background-color:#FAC813;">
