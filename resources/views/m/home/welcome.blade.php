...
<div id="wrap" class="mo-wrap">
    <header id="header" class="header headertype__mo">
        <div class="inner">
            <h1 class="head__logo head__logo--large" onclick="location.href='/'"><span class="a11y">All FURN</span></h1>
        </div>
    </header>
                ...
                <div class="modal-box__container">
                    <div class="modal-box__content">
                        ...
                        <div class="modal__util">
                            <button type="button" onclick="closeModal('#modal-page-notfund');"
                                    class="modal__button"><span>확인</span></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="reg-agrmnt_service" class="modal">
            <div class="modal__container">
                <div class="modal__content">
                    <div class="modal-box__container" style="width: 350px;">
                        <div class="modal-box__content">
