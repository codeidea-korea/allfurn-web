    ...
    <div class="prod_info">
        ...
        <div class="info_box">
            ...
            <div class="prod_option">
                ...
                <div class="sub_tot_price">{{ $item->is_price_open ? number_format($item->price, 0).'원' : (($item->price_text === null || $item->price_text === '' || $item->price_text ==='가격 안내 문구 선택') ? '업체 문의' : $item->price_text) }}</div>
            </div>
        </div>
        @endif
    </div>
