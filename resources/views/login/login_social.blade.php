            ...
            <div class="tab_content">
                ...
                ">
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-3">
                        ...
                        <a id="appleid-signin" data-color="black" data-border="true" data-type="sign in" class="btn btn-line2 gap-2" style="border:1px solid #2a2a2a; color:#2a2a2a;">
                            ...
                            $('#appleid-signin').click(async () => {
                                ...
                                try {
                                    ...
                                    if(res.authorization) {
                                        const parsingInfo = JSON.parse(
                                            decodeURIComponent(
                                                window
                                                .atob(res.authorization.id_token.split('.')[1].replace(/-/g, '+').replace(/_/g, '/'))
                                                .split('')
                                                .map(function (c) {
                                        ...
                                        const popup = window.open('/social/social?social=apple&id='+parsingInfo.email+'&email='+parsingInfo.email+'&name=&phone_number=&', "Apple Login", "width=500,height=600");
                                        popup.window.focus();
...
<div class="modal" id="login_not_match">
    <div class="modal_bg" onclick="modalClose('#login_not_match'); window.location.href='/signin';"></div>
    <div class="modal_inner modal-sm">
        <button class="close_btn" onclick="modalClose('#login_not_match'); window.location.href='/signin';" type="button"><svg class="w-11 h-11"><use xlink:href="./img/icon-defs.svg#Close"></use></svg></button>
        <div class="modal_body agree_modal_body">
            <p class="text-center py-4"><b>아이디 패스워드가 일치하지 않습니다.<br>다시 확인해주세요.</b></p>
            <div class="flex gap-2 justify-center">
                <button class="btn btn-primary w-1/2 mt-5" onclick="modalClose('#login_not_match'); window.location.href='/signin';" type="button">확인</button>
            </div>
        </div>
    </div>
</div>
