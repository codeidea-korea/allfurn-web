...
<a href="{{ $google_apiURL }}" class="btn w-full mt-2.5 btn-line2" style="border-color: var(--main_color) !important; color: var(--main_color) !important; margin-bottom: 0.625rem">구글 로그인</a>
                    ...
                    <div class="grid grid-cols-2 gap-2 mt-3">
                        <a href="javascript:;" class="btn btn-line2 gap-2" style="border:1px solid #6dc66e; color:#6dc66e;">
                        ...
                        <a href="javascript:;" class="btn btn-line2 gap-2" style="border:1px solid #aa4c4c; color:#aa4c4c;">
                        ...
                        <a href="javascript:;" class="btn btn-line2 gap-2" style="border:1px solid #fac813; color:#fac813;">
                        ...
                        <a href="javascript:;" class="btn btn-line2 gap-2" style="border:1px solid #2a2a2a; color:#2a2a2a;">
                    ...
                    <a href="javascript:;" class="btn w-full mt-8 btn-primary-line gap-2" style="height:auto; padding:10px 0; font-size:20px; ">
