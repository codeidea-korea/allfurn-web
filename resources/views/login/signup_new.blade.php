                ...
                <div class="form_box !w-full">
                    <div class="pb-10">
                        <div class="grid grid-cols-2 gap-10">
                            <div>
                                <a href="javascript:;" id="naver" class="btn mb-2 text-white" style="background-color:#6dc66e;">
                                ...
                                <a href="javascript:;" id="kakao" class="btn mb-2 text-white" style="background-color:#FAC813;">
