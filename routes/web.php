...
Route::get('/mcompany/{userIdx}', 'MypageController@getCompanyAjaxByIdx');
...
Route::prefix('estimate') -> name('estimate') -> group(function(){
    ...
    Route::post('/order/hold', 'EstimateController@holdOrder');
    Route::post('/order/save', 'EstimateController@saveOrder');
});
